...
- **[Rustok Wallet](https://github.com/temrjan/rustok)** - Self-custody Ethereum Agent Wallet with hard policy limits, DeFi tracking, and audit logging. All chains enabled by default.
